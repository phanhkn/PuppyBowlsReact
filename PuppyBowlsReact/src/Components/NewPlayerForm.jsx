...
export default function NewPlayerForm({ APIURL }) {
  ...
  const handleBreedChange = (event) => {
    ...
    const breedImages = {
      ...
      bigPoodle:
        "https://discovery.sndimg.com/content/dam/images/discovery/editorial/shows/p/puppybowl/2022/meet-the-players/headshots/Copy%20of%20Benny_EWF_2805.jpg.rend.hgtvcom.966.966.suffix/1641528997533.jpeg",
      staffordshire:
    ...
    <form onSubmit={handleSubmit}>
      ...
      <img
        ...
        onError={({ currentTarget }) => {
          ...
          currentTarget.src =
            "https://i.etsystatic.com/8104547/r/il/e80dec/995392536/il_570xN.995392536_3r85.jpg";
        }}
      />
      <br></br>
